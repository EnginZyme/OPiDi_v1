...
import "../../matchMedia";
import MultiWellSelectionForm from "@/components/forms/MultiWellSelectionForm";
...
describe("shallowMounted MultiWellSelectionForm", () => {
  let getters;
  let store;
  let wrapper;
  ...
  beforeEach(() => {
    ...
    wrapper = shallowMount(MultiWellSelectionForm, {
      store,
      localVue,
      propsData: {
