...
describe("shallowMounted ProtocolsView", () => {
  let getters;
  let store;
  let wrapper;
  ...
  beforeEach(() => {
    getters = {
      sharedProtocols: () => sampleSharedProtocols,
      userProtocols: () => sampleUserProtocols,
    };
    ...
    wrapper = shallowMount(ProtocolsView, {
      store,
      localVue,
    });
  });
