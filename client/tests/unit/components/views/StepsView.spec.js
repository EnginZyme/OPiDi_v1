...
const sampleCachedProtocolStepCounter = 9;
...
const sampleProtocolEditorVariables = {
  ...
  locSeqID: "0",
  locSeqCategory: "sequence",
};

describe("shallowMounted StepsView", () => {
  let getters;
  let store;
  let wrapper;
  ...
  beforeEach(() => {
    getters = {
      cachedProtocolStepCounter: () => sampleCachedProtocolStepCounter,
    ...
    wrapper = shallowMount(StepsView, {
      store,
      localVue,
    });
  });
